...
# first_data 변수에 비어있는 dict 할당
first_data = {}
# first_data 제목 key에 문제의 제목에 해당하는 값 할당
first_data['제목'] = data[0]['results'][0]['properties']['제목']['title'][0]['plain_text']
# first_data 일차 key에 일차에 해당하는 값을 할당
first_data['일차'] = data[0]['results'][0]['properties']['일차']['number']
# 정수로 할당
first_data['일차'] = int(first_data['일차'])
# first_data 제목 key에 단계에 해당하는 값 할당
first_data['단계'] = data[0]['results'][0]['properties']['단계']['select']['name']
# {value}단계가 되도록 값을 변경하여 할당
first_data['단계'] = str(first_data['단계']) + "단계"
# 과목 key에는 과목에 해당하는 값 할당
